// Header breadcrumb metadata per warehouse page.
export const PAGE_META = {
  dashboard: { section: 'Overview', page: 'Dashboard', heading: 'Dashboard' },
  products: { section: 'Catalog', page: 'Product Master', heading: 'Product Master' },
  inventory: { section: 'Inventory', page: 'Stock Levels', heading: 'Stock Levels' },
