      ...
      >
        <div className="px-5 py-6 flex items-center gap-3 border-b border-white/10">
          <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm shrink-0">
            <Icon name="cube" className="text-navy" style={{ fontSize: '22px' }} />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-white font-bold text-[15px] leading-tight">Central Warehouse</p>
            <p className="text-white/40 text-[11px] tracking-wider uppercase">Al Fatah · WH Portal</p>
          </div>
        ...
        <div className="px-4 py-4 border-t border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white text-[12px] font-semibold truncate">Zain Khan</p>
              <p className="text-white/40 text-[11px] truncate">zain@alfatah.pk</p>
            </div>
