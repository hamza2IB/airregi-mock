...
import { TRANSFER_REJECT_REASONS } from '../../data/warehouseData'
    ...
    <>
      ...
      <div className="px-6 py-5 space-y-4">
        <div className="flex items-start gap-2.5 bg-brand-red/5 border border-brand-red/15 rounded-xl px-4 py-3">
          ...
          <p className="text-[11px] text-gray-600 leading-relaxed">The store will be notified of this rejection with the reason you provide so they can take alternative action.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <textarea value={note} onChange={(e) => setNote(e.target.value)} rows={3} className={`${INP} resize-none`} placeholder="Explain to the store manager what they should do instead…"></textarea>
        </div>
      </div>
