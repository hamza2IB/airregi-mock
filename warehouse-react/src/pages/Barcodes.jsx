...
export default function Barcodes() {
  ...
  const products = useMemo(() => {
    ...
    return INV_DATA.filter((i) => !q || i.name.toLowerCase().includes(q) || i.sku.toLowerCase().includes(q))
  }, [search])
    ...
    <div className="p-8 max-md:p-3.5">
      ...
      <div className="flex items-start gap-2.5 bg-brand-blue/5 border border-brand-blue/15 rounded-xl px-4 py-3 mb-6">
        ...
        <p className="text-[11px] text-gray-600 leading-relaxed">
          Select products below to generate and print barcode labels. Supported formats: <strong className="text-navy-dark">Code 128, EAN-13, QR Code</strong>. Barcode assignment updates globally — all locations see the new barcode immediately.
        </p>
      </div>
                ...
                return (
                  <label key={i.sku} className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50/70 cursor-pointer transition">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-gray-400 font-mono">{i.sku} · {i.onHand} units</p>
                    </div>
