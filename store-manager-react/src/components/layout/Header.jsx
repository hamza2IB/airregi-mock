...
export default function Header({ meta, onOpenMobileSidebar, onAlerts }) {
  return (
    <header
    ...
    >
      <div className="flex items-center gap-4 px-8 max-md:px-4 max-md:gap-2.5" style={{ height: '64px' }}>
        ...
        >
          <Icon name="menu-outline" style={{ fontSize: '19px', color: '#1a2d6b' }} />
        </button>
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            <Icon name="notifications-outline" className="text-navy" style={{ fontSize: '18px' }} />
          </button>
          <div className="flex items-center gap-2.5 px-2 py-1.5 rounded-xl cursor-pointer hover:bg-page transition">
            <div
              className="shrink-0"
              style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'linear-gradient(135deg,#3366cc,#1a2d6b)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', fontWeight: 800, color: '#fff' }}
            >
              NH
            </div>
            <div className="max-sm:hidden">
              <div style={{ fontSize: '12.5px', fontWeight: 800, color: '#0a1535', lineHeight: 1.25, whiteSpace: 'nowrap' }}>Nadia Hasan</div>
              <div style={{ fontSize: '10.5px', fontWeight: 500, color: '#94a3b8', lineHeight: 1.25 }}>Store Manager</div>
            </div>
          </div>
        </div>
      </div>
