...
// Shared row-action button used across every owner-react list/table so all action
// buttons have an identical structure (icon + label). Only the semantic colour
// (tone) changes — neutral for view/edit, primary for the main action, and
// green/orange/red for activate/deactivate/destructive actions.
const TONES = {
  ...
  blue: 'border-brand-blue/20 bg-brand-blue/5 text-brand-blue hover:bg-brand-blue/10',
}
