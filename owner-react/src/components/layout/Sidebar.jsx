...
const NAV_GROUPS = [
  { label: 'Overview', items: [{ key: 'dashboard', icon: 'grid-outline', label: 'Dashboard' }] },
  {
    label: 'Business',
    items: [
      { key: 'company', icon: 'business-outline', label: 'Company Profile' },
  ...
  },
  {
    label: 'Operations',
    items: [
      { key: 'users', icon: 'people-outline', label: 'Users & Staff' },
      { key: 'subscription', icon: 'card-outline', label: 'Subscription' },
    ],
  },
  { label: 'Reports', items: [{ key: 'revenue', icon: 'trending-up-outline', label: 'Revenue Report' }] },
      ...
      >
        <div className="px-5 py-6 flex items-center gap-3 border-b border-white/10">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-white font-bold text-[15px] leading-tight">Al Fatah</p>
            <p className="text-white/40 text-[11px] tracking-wider uppercase">Owner Portal</p>
          </div>
        ...
        <div className="px-4 py-4 border-t border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white text-[12px] font-semibold truncate">Ahmed Raza</p>
              <p className="text-white/40 text-[11px] truncate">ahmed@alfatah.pk</p>
            </div>
